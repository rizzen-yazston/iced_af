    ...
    TabId: Eq + Clone,
{
    ...
    /// Similar to `new` but with a given Vector of the [`TabLabel`](crate::sidebar::TabLabel)s.
    ///
    /// It expects:
    ///     * the index of the currently active tab.
    ...
    /// [`TabLabel`](crate::sidebar::TabLabel)s of the [`Sidebar`].
    #[must_use]
    ...
    /// Sets the icon size of the [`TabLabel`](crate::sidebar::TabLabel)s of the [`Sidebar`].
    #[must_use]
    ...
    /// Pushes a [`TabLabel`](crate::sidebar::TabLabel) to the [`Sidebar`].
    #[must_use]
    ...
    /// Sets the text size of the [`TabLabel`](crate::sidebar::TabLabel)s of the [`Sidebar`].
    #[must_use]
    ...
    TabId: Eq + Clone,
{
    ...
    /// [`TabLabel`](super::sidebar::TabLabel) along with the tab's content.
    ///
    /// It expects:
    ///     * the index of the currently active tab.
    ...
    /// Sets the size of the close icon of the
    /// [`TabLabel`](super::sidebar::TabLabel) of the
    ...
    /// Sets the font of the icons of the
    /// [`TabLabel`](super::sidebar::TabLabel)s of the
    /// [`Sidebar`](super::sidebar::Sidebar).
    #[must_use]
    pub fn icon_font(mut self, font: Font) -> Self {
    ...
    /// Sets the icon size of the [`TabLabel`](super::sidebar::TabLabel) of the
    /// [`Sidebar`](super::sidebar::Sidebar).
    #[must_use]
    pub fn icon_size(mut self, icon_size: f32) -> Self {
    ...
    /// Pushes a [`TabLabel`](super::sidebar::TabLabel) along with the tabs
    ...
    /// Sets the height of the [`Sidebar`](super::sidebar::Sidebar) of the [`SidebarWithContent`].
    #[must_use]
    ...
    /// Sets the width of the [`Sidebar`](super::sidebar::Sidebar) of the [`SidebarWithContent`].
    #[must_use]
    ...
    /// Sets the [`SidebarPosition`] of the [`Sidebar`](super::sidebar::Sidebar).
    #[must_use]
    ...
    /// Sets the style of the [`Sidebar`](super::sidebar::Sidebar).
    #[must_use]
    ...
    /// Sets the text size of the [`TabLabel`](super::sidebar::TabLabel) of the
    /// [`Sidebar`](super::sidebar::Sidebar).
    #[must_use]
    pub fn text_size(mut self, text_size: f32) -> Self {
